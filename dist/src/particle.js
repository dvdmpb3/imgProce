...
export { ParticleText };
var ParticleFlotante = /** @class */ (function () {
    function ParticleFlotante(width, height, screenCanvas) {
        this.ctx = screenCanvas;
        this.height = height;
        this.width = width;
    ...
    ParticleFlotante.prototype.draw = function () {
        this.ctx.beginPath();
        this.ctx.arc(this.x, this.y, this.size, 0, Math.PI * 2, false);
        this.ctx.fillStyle = "white";
        this.ctx.fill();
    };
    ParticleFlotante.prototype.update = function () {
    ...
    return ParticleFlotante;
}());
export { ParticleFlotante };
